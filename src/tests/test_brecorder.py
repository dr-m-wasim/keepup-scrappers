...
class TestbrecorderSpider:
    ...
    def test_parse_method(self):
        ...
        with open(r'tests\test_data\brecorder\listing_sample.html', 'r', encoding='utf-8') as f:
            html_content = f.read()    
    ...
    def test_parse_details_method(self):
        ...
        with open(r'tests\test_data\brecorder\detail_sample.html', 'r', encoding='utf-8') as f:
            html_content = f.read()
