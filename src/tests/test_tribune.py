...
class TestTribuneSpider:
    ...
    def test_parse_method(self):
        ...
        with open(r'E:\keepup\keepup-scrappers\src\tests\test_data\tribune\listing_sample.html', 'r', encoding='utf-8') as f:
            html_content = f.read()    
    ...
    def test_parse_details_method(self):
        ...
        with open(r'E:\keepup\keepup-scrappers\src\tests\test_data\tribune\detail_sample.html', 'r', encoding='utf-8') as f:
            html_content = f.read()
