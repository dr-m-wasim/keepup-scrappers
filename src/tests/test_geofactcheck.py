...
class TestGFCSpider:
    ...
    def test_parse_method(self):
        ...
        with open(r'test_data\geofactcheck\listing_sample.html', 'r', encoding='utf-8') as f:
            html_content = f.read()    
        ...
        assert item['title'] == 'Fact-check: Video claiming Taliban shot down Pakistani helicopter is false'
        assert item['publication_date'] == 'Jan 07, 2025'
        assert item['detail_url'] ==  'https://www.geo.tv/latest/583874-fact-check-video-claiming-taliban-shot-down-pakistani-helicopter-is-false'
        assert item['image_urls'][0] == 'https://www.geo.tv/assets/uploads/updates/2025-01-07/l_583874_122526_updates.jpg'
        

    def test_parse_details_method(self):

        with open(r'tests\test_data\geofactcheck\detail_sample.html', 'r', encoding='utf-8') as f:
            html_content = f.read()
