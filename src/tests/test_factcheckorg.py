...
class TestfactcheckorgSpider:
    ...
    def test_parse_method(self):
        ...
        with open(r'D:\myenv\keepup-scrappers\src\tests\test_data\factcheckorg\listing_sample.html', 'r', encoding='utf-8') as f:
            html_content = f.read()    
    ...
    def test_parse_details_method(self):
        ...
        with open(r'D:\myenv\keepup-scrappers\src\tests\test_data\factcheckorg\detail_sample.html', 'r', encoding='utf-8') as f:
            html_content = f.read()
