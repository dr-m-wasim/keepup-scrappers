...
class TestSFCSpider:
    ...
    def test_parse_method(self):
        ...
        with open(r'D:\myenv\keepup-scrappers\src\tests\test_data\sochfactcheck\listing_sample.json', 'r', encoding='utf-8') as f:
            html_content = f.read()    
    ...
    def test_parse_details_method(self):
        ...
        with open(r'D:\myenv\keepup-scrappers\src\tests\test_data\sochfactcheck\detail_sample.html', 'r', encoding='utf-8') as f:
            html_content = f.read()
