...
class TestGNSpider:
    ...
    def test_parse_method(self):
        ...
        with open(r'E:\keepup\keepup-scrappers\src\tests\test_data\geonews\listing_sample.html', 'r', encoding='utf-8') as f:
            html_content = f.read()    
    ...
    def test_parse_details_method(self):
        ...
        with open(r'E:\keepup\keepup-scrappers\src\tests\test_data\geonews\detail_sample.html', 'r', encoding='utf-8') as f:
            html_content = f.read()
